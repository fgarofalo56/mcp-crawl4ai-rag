...
ENV PYTHONPATH=/app/src:/app/knowledge_graphs
...
# Run the MCP server directly using src.server module (bypasses run_mcp.py)
# This respects the TRANSPORT environment variable set by docker-compose
