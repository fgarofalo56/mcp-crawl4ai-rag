...
class HallucinationReporter:
    ...
    def generate_comprehensive_report(
        ...
        Args:
            validation_result: Validation results from script analysis

        Returns:
            Comprehensive report dictionary with metadata, summary, and details
        """
        ...
        self._process_import_validations(
            validation_result, valid_items, invalid_items, uncertain_items, not_found_items
        )
        self._process_class_validations(
            validation_result, valid_items, invalid_items, uncertain_items, not_found_items
        )

        # Track reported items to avoid duplicates between methods and attributes
        reported_items: set = set()
        self._process_method_validations(
            validation_result,
            reported_items,
            valid_items,
            invalid_items,
        ...
        self._process_attribute_validations(
            validation_result,
            reported_items,
            valid_items,
            invalid_items,
        ...
        self._process_function_validations(
            validation_result, valid_items, invalid_items, uncertain_items, not_found_items
        )
    ...
    def _process_import_validations(
        self,
        ...
        """Process import validations and categorize results.

        Args:
            validation_result: Script validation result containing import validations
            valid_items: List to append valid import items to
            invalid_items: List to append invalid import items to
            uncertain_items: List to append uncertain import items to
            not_found_items: List to append not found import items to
        """
    ...
    def _process_class_validations(
        self,
        validation_result: ScriptValidationResult,
        valid_items: list[dict[str, Any]],
        invalid_items: list[dict[str, Any]],
        ...
        """Process class instantiation validations and categorize results.

        Args:
            validation_result: Script validation result containing class validations
            valid_items: List to append valid class items to
            invalid_items: List to append invalid class items to
            uncertain_items: List to append uncertain class items to
            not_found_items: List to append not found class items to
        """
    ...
    def _process_method_validations(
        self,
        validation_result: ScriptValidationResult,
        reported_items: set,
        valid_items: list[dict[str, Any]],
        ...
        """Process method call validations and categorize results.

        Args:
            validation_result: Script validation result containing method validations
            reported_items: Set to track reported items and avoid duplicates
            valid_items: List to append valid method items to
            invalid_items: List to append invalid method items to
            uncertain_items: List to append uncertain method items to
            not_found_items: List to append not found method items to
        """
    ...
    def _process_attribute_validations(
        self,
        validation_result: ScriptValidationResult,
        reported_items: set,
        valid_items: list[dict[str, Any]],
        ...
        """Process attribute access validations and categorize results.

        Args:
            validation_result: Script validation result containing attribute validations
            reported_items: Set to check for duplicates (skip if already reported as method)
            valid_items: List to append valid attribute items to
            invalid_items: List to append invalid attribute items to
            uncertain_items: List to append uncertain attribute items to
            not_found_items: List to append not found attribute items to
        """
    ...
    def _process_function_validations(
        self,
        validation_result: ScriptValidationResult,
        valid_items: list[dict[str, Any]],
        invalid_items: list[dict[str, Any]],
        ...
        """Process function call validations and categorize results.

        Args:
            validation_result: Script validation result containing function validations
            valid_items: List to append valid function items to
            invalid_items: List to append invalid function items to
            uncertain_items: List to append uncertain function items to
            not_found_items: List to append not found function items to
        """
    ...
    def _build_report_dict(
        ...
        """Build final report dictionary from categorized validation items.

        Args:
            validation_result: Script validation result with overall metrics
            valid_items: List of valid validation items
            invalid_items: List of invalid validation items
            uncertain_items: List of uncertain validation items
            not_found_items: List of not found validation items
            library_summary: Summary of libraries analyzed

        Returns:
            Complete report dictionary with metadata, summary, and details
        """
        return {
            "analysis_metadata": {
