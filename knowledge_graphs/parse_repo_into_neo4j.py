...
# Type variable for async decorators
T = TypeVar("T")
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.driver = AsyncGraphDatabase.driver(
                ...
                connection_acquisition_timeout=30.0,  # Reduced from 60s
                connection_timeout=10.0,  # Reduced from 30s
                keep_alive=True,
            )
            ...
            # Create constraints and indexes with individual error handling
            ...
            async with self.driver.session() as session:
                try:
                    ...
                    logger.warning(f"Constraint creation failed (non-critical): {e}")
            ...
            logger.error(f"Failed to initialize DirectNeo4jExtractor: {e}")
            raise
