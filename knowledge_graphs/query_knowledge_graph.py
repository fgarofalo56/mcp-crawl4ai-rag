...
class KnowledgeGraphQuerier:
    ...
    def __init__(self, neo4j_uri: str, neo4j_user: str, neo4j_password: str) -> None:
        ...
        self.neo4j_user: str = neo4j_user
    ...
    async def list_classes(self, repo_name: str = None, limit: int = 20) -> list[dict[str, Any]]:
    ...
    async def explore_class(self, class_name: str) -> dict[str, list[dict[str, Any]]]:
    ...
    async def search_method(self, method_name: str, class_name: str = None) -> list[dict[str, Any]]:
    ...
    async def run_custom_query(self, query: str) -> list[dict[str, Any]]:
